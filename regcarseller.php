...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO seat_seller(uname, email, mol, pswd, ads) 
            VALUES ('$name', '$email', '$mobile', '$password', '$address')";

    if ($conn->query($sql) === TRUE) {
        echo "<script>alert('Registered Successfully!'); window.location.href='carsellerlogin.php';</script>";
    } else {
    ...
    <div class="form-box">
        ...
        <form action="" method="POST">
            <div class="row g-3">
                ...
                <p class="register-text text-white">Already have an account? <a href="carsellerlogin.php" class="register-link">Login</a></p>
