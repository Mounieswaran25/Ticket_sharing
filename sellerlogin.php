...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $email = $_POST['email'];
    $pswd = $_POST['pswd'];
    $res = mysqli_query($conn, "SELECT * FROM seller_user WHERE email='$email' AND pswd='$pswd'");
...
<div class="overlay">
    <div class="login-box">
        ...
        <form method="POST">
            ...
            <p class="register-text">Don't have an account? <a href="regseller.php" class="register-link">Register</a></p>
